...
const formSchema = z.object({
  ...
  rdsDocument: z.instanceof(File, { message: "Dokumen RDS harus dilampirkan" }).nullable()
});
          ...
          <div className="space-y-2">
            ...
            <Popover>
              ...
              <PopoverContent className="w-auto p-0" align="start">
                <Calendar
                  mode="single"
                  selected={formData.tanggalPakai ?? undefined}
                  onSelect={(date) => setFormData({...formData, tanggalPakai: date ?? null})}
                  initialFocus
                />
              </PopoverContent>
            </Popover>
